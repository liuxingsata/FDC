				...
				<div class="navbar-inner">
					...
					<div class="nav-collapse collapse">
						<p class="navbar-text pull-right">
							<a href="login.jsp"><input type="submit" id="submit"
								value="登录" class="btn btn-lg btn-success" /></a> <a
								href="register.jsp"><input type="button" id="signup"
								value="注册" class="btn btn-lg btn-success" /></a>
						</p>
						<ul class="nav">
			...
			<div class="item active">
				...
				<div class="container">
					<div class="carousel-caption">
						...
						<a class="btn btn-large btn-primary" href="register.jsp">马上注册！</a>
					</div>
				</div>
			</div>
			<div class="item">
	...
	<div class="container marketing">
		...
		<div class="row">
			<div class="span4">
				...
				<p></p>
				<p>
					<a class="btn" href="register.jsp">查看细节 &raquo;</a>
				</p>
			</div>
			<!-- /.span4 -->
			<div class="span4">
		...
		<footer>
			...
			<strong>Copyright &copy; 2016 <a href="#">Liuxingsata</a>.
