...
<body>
	...
	<div
		...
		<table>
			<tr>
				<td><h1>
						<span class="red">注册失败！用户名已存在！</span>
					</h1></td>
			</tr>
			<tr>
				<td><h2>
						<span class="red" id="showTimes"></span><span class="red">秒后自动返回注册页面</span>
					</h2></td>
			</tr>
			<tr>
				<td><a class="btn btn-large btn-primary" href="register.jsp">手动返回</a></td>
			</tr>
		</table>
	</div>
	<!-- Javascript -->
