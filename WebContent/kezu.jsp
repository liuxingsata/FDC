...
<script type="text/javascript">
	$(document).ready(function(){
		$("#searchbutton").click(function(){
			$("#01").load("searchhouse.jsp",{search:$("#search").val(),tablename:"renthouse"});
		})
...
<body>
	...
	<div class="navbar navbar-inverse navbar-fixed-top" id="03">
			...
			<div class="container-fluid">
				...
				<div class="nav-collapse collapse">
					...
					<ul class="nav">
						...
						<li class="active"><a href="kezu.jsp">可租房信息</a></li>
				...
				<div >
					<table  style='text-align:center'>
						<tr class="tb_title" >
							...
							<td width="10%" style="text-align:center">房屋型号</td>
							<td width="10%" style="text-align:center">房屋面积</td>
							<td width="10%" style="text-align:center">所在楼层</td>
							<td width="20%" style="text-align:center">房屋地址</td>
							<td width="10%" style="text-align:center">房屋所有者</td>
							<td width="25%" style="text-align:center">参考图片</td>

						</tr>
						<tbody>
							<%
								String tablename = "renthouse";
