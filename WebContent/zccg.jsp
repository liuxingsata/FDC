...
<meta charset="utf-8">
<title>房地产-注册</title>
<meta http-equiv="refresh" content="5;url=index_home.jsp">
...
<body>
	...
	<div
		...
		<table>
			<tr>
				<td><h1>
						<span class="red">注册成功</span>
					</h1></td>
			</tr>
			<tr>
				<td><h2>
						<span class="red" id="showTimes"></span><span class="red">秒后自动登录主页</span>
					</h2></td>
			</tr>
			<tr>
				<td><a class="btn btn-large btn-primary" href="index_home.jsp">手动登录主页</a></td>
			</tr>
		</table>
	</div>
	<!-- Javascript -->
